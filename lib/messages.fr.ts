export const messages = {
    ...
    'results': {
        ...
        'incomplete': 'En attente de plus de répondants',
        'details-show': 'Afficher le détail',
        'details-hide': 'Cacher le détail',
        'details-legend': 'Nombre de votes / Nombre de répondants',
        'header-results': 'Résultats',
        'header-standard': 'Réponses types',
        'header-custom': 'Réponses ouvertes',
